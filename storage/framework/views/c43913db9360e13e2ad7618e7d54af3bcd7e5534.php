                    ...
                    <div class="row">
                        ...
                        <table style="border: 1px solid black; width: 100%; padding:5px;">
                            ...
                            <tr class="<?php echo e(($index%2) ? 'gray' : ''); ?>">
                                ...
                                <td>Rp. <?php echo e(format_idr($item->keuangan->jumlah)); ?></td>
                                <?php
...
</html><?php /**PATH D:\xampp\htdocs\Aplikasi-Manajemen-SPP-Sekolah\resources\views/admin/dashboard/cetak.blade.php ENDPATH**/ ?>